...
START_TEST(test_1) {
  ...
  A.matrix[1][0] = 3.0;
  A.matrix[1][1] = 4.0;
  double result = s21_recursive_determinant(2, &A);
...
START_TEST(test_2) {
  ...
  A.matrix[2][1] = 8.0;
  A.matrix[2][2] = 9.0;
  double result = s21_recursive_determinant(3, &A);
...
START_TEST(test_3) {
  ...
  A.matrix[3][2] = 15.0;
  A.matrix[3][3] = 16.0;
  double result = s21_recursive_determinant(4, &A);
...
START_TEST(test_4) {
  ...
  A.matrix[4][3] = 24.0;
  A.matrix[4][4] = 25.0;
  double result = s21_recursive_determinant(5, &A);
