...
int main() {
  ...
  Suite *s_to_upper = make_s21_to_upper_suite();
  Suite *s_to_lower = make_s21_to_lower_suite();
  Suite *s_sscanf = make_s21_sscanf_suite();
  Suite *s_trim = make_s21_trim_suite();
  Suite *s_sprintf = make_s21_sprintf_suite();
  ...
  srunner_add_suite(runner, s_strncat);
  ...
  srunner_add_suite(runner, s_to_upper);
  srunner_add_suite(runner, s_to_lower);
  srunner_add_suite(runner, s_sscanf);
  srunner_add_suite(runner, s_trim);
